...
Paragraph: "Основатель Hoty Dogy — QSR-сети с оборотом более 2 млрд сум в месяц и 8+ филиалами. Прошёл на практике через продукт, маркетинг, экономику, найм, операционку, открытия, доставку и масштабирование ресторанной сети." (text-[#A8A29E] text-base leading-relaxed mt-6).
